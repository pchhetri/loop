  ...
  render() {
    return (
      ...
      <div className={s.terms}>
        ...
        <p>These Terms will be governed by and interpreted in accordance with the laws of the State of WI, and you submit to the non-exclusive jurisdiction of the state and federal courts located in WI for the resolution of any disputes.</p>
        </div>
      </Layout>
    );
  }
